  ...
  resolve(
    ...
    return this.productService.getProduct(id).pipe(
      ...
      switchMap((customersViewedProducts) => {
        ...
        return this.recommendedProductsService.getRecommendedProducts(id);
      }),
      switchMap((recommendedProducts) => {
        productComponentData.recommendedProducts = recommendedProducts;
        return this.viewedProductsService.getViewedProducts(id);
      }),
      map((viewedProducts) => {
        productComponentData.viewedProducts = viewedProducts;
