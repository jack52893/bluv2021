...
export class PopularComponent implements OnInit {
  ...
  products: Product[] = [
    ...
    {id: '4', name: 'Laptop Dell Inspiron 350', description: 'Laptop Dell Inspiron 350', price: '600', stock: '5', imageUrl: 'assets/images/products/product-4.jpg', images: [] },
    {id: '5', name: 'Laptop Dell Inspiron 450', description: 'Laptop Dell Inspiron 450', price: '650', stock: '0', imageUrl: 'assets/images/products/product-5.jpg', images: [] },
